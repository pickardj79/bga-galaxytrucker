...
$this->card = [
  ...
  3 => ['round' => 1, 'id' => 3, 'type' => 'stardust'],
  4 => ['round' => 1, 'id' => 4, 'type' => 'openspace'],
  5 => ['round' => 1, 'id' => 5, 'type' => 'openspace'],
  6 => ['round' => 1, 'id' => 6, 'type' => 'openspace'],
  7 => ['round' => 1, 'id' => 7, 'type' => 'openspace'],
  8 => ['round' => 1, 'id' => 8, 'type' => 'meteoric', 'meteors' => ['b0', 's270', 's90']],
  9 => ['round' => 1, 'id' => 9, 'type' => 'meteoric', 'meteors' => ['s0', 's180', 's270', 's90']],
  10 => ['round' => 1, 'id' => 10, 'type' => 'meteoric', 'meteors' => ['b0', 's0', 'b0']],
  11 => [
    'round' => 1,
    'id' => 11,
    'type' => 'planets',
  ...
  16 => ['round' => 1, 'id' => 16, 'type' => 'abship', 'crew' => 3, 'reward' => 4, 'days_loss' => 1],
  17 => ['round' => 1, 'id' => 17, 'type' => 'abship', 'crew' => 2, 'reward' => 3, 'days_loss' => 1],
  18 => [
    'round' => 1,
    'id' => 18,
    'type' => 'abstation',
  ...
  19 => ['round' => 1, 'id' => 19, 'type' => 'abstation', 'crew' => 6, 'reward' => ['red', 'red'], 'days_loss' => 1],
  20 => ['round' => 2, 'id' => 20, 'type' => 'slavers'],
  21 => ['round' => 2, 'id' => 21, 'type' => 'smugglers'],
  22 => ['round' => 2, 'id' => 22, 'type' => 'pirates'],
  23 => ['round' => 2, 'id' => 23, 'type' => 'stardust'],
  24 => ['round' => 2, 'id' => 24, 'type' => 'epidemic'],
  25 => ['round' => 2, 'id' => 25, 'type' => 'openspace'],
  26 => ['round' => 2, 'id' => 26, 'type' => 'openspace'],
  27 => ['round' => 2, 'id' => 27, 'type' => 'openspace'],
  28 => ['round' => 2, 'id' => 28, 'type' => 'meteoric', 'meteors' => ['s0', 'b0', 's270', 'b270', 's270']],
  29 => ['round' => 2, 'id' => 29, 'type' => 'meteoric', 'meteors' => ['s0', 's0', 's180', 's180', 's270', 's90']],
  30 => ['round' => 2, 'id' => 30, 'type' => 'meteoric', 'meteors' => ['s0', 'b0', 's90', 'b90', 's90']],
  31 => [
    'round' => 2,
    'id' => 31,
    'type' => 'planets',
  ...
  35 => ['round' => 2, 'id' => 35, 'type' => 'combatzone'],
  36 => ['round' => 2, 'id' => 36, 'type' => 'abship', 'crew' => 5, 'reward' => 8, 'days_loss' => 2],
  37 => ['round' => 2, 'id' => 37, 'type' => 'abship', 'crew' => 4, 'reward' => 6, 'days_loss' => 1],
  38 => [
    'round' => 2,
    'id' => 38,
    'type' => 'abstation',
  ...
  39 => ['round' => 2, 'id' => 39, 'type' => 'abstation', 'crew' => 7, 'reward' => ['red', 'yellow'], 'days_loss' => 1],
  40 => ['round' => 3, 'id' => 40, 'type' => 'slavers'],
  41 => ['round' => 3, 'id' => 41, 'type' => 'smugglers'],
  42 => ['round' => 3, 'id' => 42, 'type' => 'pirates'],
  43 => ['round' => 3, 'id' => 43, 'type' => 'sabotage'],
  44 => ['round' => 3, 'id' => 44, 'type' => 'epidemic'],
  45 => ['round' => 3, 'id' => 45, 'type' => 'openspace'],
  46 => ['round' => 3, 'id' => 46, 'type' => 'openspace'],
  47 => ['round' => 3, 'id' => 47, 'type' => 'openspace'],
  48 => ['round' => 3, 'id' => 48, 'type' => 'meteoric', 'meteors' => ['b90', 's90', 'b90', 's0', 's180']],
  49 => [
    'round' => 3,
    'id' => 49,
    'type' => 'meteoric',
  ...
  50 => ['round' => 3, 'id' => 50, 'type' => 'meteoric', 'meteors' => ['b270', 's270', 'b270', 's0', 's180']],
  51 => [
    'round' => 3,
    'id' => 51,
    'type' => 'planets',
  ...
  55 => ['round' => 3, 'id' => 55, 'type' => 'combatzone'],
  56 => ['round' => 3, 'id' => 56, 'type' => 'abship', 'crew' => 7, 'reward' => 11, 'days_loss' => 2],
  57 => ['round' => 3, 'id' => 57, 'type' => 'abship', 'crew' => 6, 'reward' => 10, 'days_loss' => 2],
  58 => [
    'round' => 3,
    'id' => 58,
    'type' => 'abstation',
