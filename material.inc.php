...
$this->cardNames = [
  CARD_SLAVERS => clienttranslate('Slavers'),
  CARD_SMUGGLERS => clienttranslate('Smugglers'),
  CARD_PIRATES => clienttranslate('Pirates'),
  CARD_STARDUST => clienttranslate('Stardust'),
  CARD_OPEN_SPACE => clienttranslate('Open Space'),
  CARD_METEORIC_SWARM => clienttranslate('Meteoric Swarm'),
  CARD_PLANETS => clienttranslate('Planets'),
  CARD_COMBAT_ZONE => clienttranslate('Combat Zone'),
  CARD_ABANDONED_SHIP => clienttranslate('Abandoned Ship'),
  CARD_ABANDONED_STATION => clienttranslate('Abandoned Station'),
  CARD_EPIDEMIC => clienttranslate('Epidemic'),
  CARD_SABOTAGE => clienttranslate('Sabotage'),
];
...
$this->card = [
  ...
  3 => ['round' => 1, 'id' => 3, 'type' => CARD_STARDUST],
  4 => ['round' => 1, 'id' => 4, 'type' => CARD_OPEN_SPACE],
  5 => ['round' => 1, 'id' => 5, 'type' => CARD_OPEN_SPACE],
  6 => ['round' => 1, 'id' => 6, 'type' => CARD_OPEN_SPACE],
  7 => ['round' => 1, 'id' => 7, 'type' => CARD_OPEN_SPACE],
  8 => ['round' => 1, 'id' => 8, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['b0', 's270', 's90']],
  9 => ['round' => 1, 'id' => 9, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['s0', 's180', 's270', 's90']],
  10 => ['round' => 1, 'id' => 10, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['b0', 's0', 'b0']],
  11 => [
    'round' => 1,
    'id' => 11,
    'type' => CARD_PLANETS,
  ...
  16 => ['round' => 1, 'id' => 16, 'type' => CARD_ABANDONED_SHIP, 'crew' => 3, 'reward' => 4, 'days_loss' => 1],
  17 => ['round' => 1, 'id' => 17, 'type' => CARD_ABANDONED_SHIP, 'crew' => 2, 'reward' => 3, 'days_loss' => 1],
  18 => [
    'round' => 1,
    'id' => 18,
    'type' => CARD_ABANDONED_STATION,
    'crew' => 5,
    'reward' => ['yellow', 'green'],
    'days_loss' => 1,
  ],
  19 => ['round' => 1, 'id' => 19, 'type' => CARD_ABANDONED_STATION, 'crew' => 6, 'reward' => ['red', 'red'], 'days_loss' => 1],
  20 => ['round' => 2, 'id' => 20, 'type' => CARD_SLAVERS],
  21 => ['round' => 2, 'id' => 21, 'type' => CARD_SMUGGLERS],
  22 => ['round' => 2, 'id' => 22, 'type' => CARD_PIRATES],
  23 => ['round' => 2, 'id' => 23, 'type' => CARD_STARDUST],
  24 => ['round' => 2, 'id' => 24, 'type' => CARD_EPIDEMIC],
  25 => ['round' => 2, 'id' => 25, 'type' => CARD_OPEN_SPACE],
  26 => ['round' => 2, 'id' => 26, 'type' => CARD_OPEN_SPACE],
  27 => ['round' => 2, 'id' => 27, 'type' => CARD_OPEN_SPACE],
  28 => ['round' => 2, 'id' => 28, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['s0', 'b0', 's270', 'b270', 's270']],
  29 => ['round' => 2, 'id' => 29, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['s0', 's0', 's180', 's180', 's270', 's90']],
  30 => ['round' => 2, 'id' => 30, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['s0', 'b0', 's90', 'b90', 's90']],
  31 => [
    'round' => 2,
    'id' => 31,
    'type' => CARD_PLANETS,
  ...
  35 => ['round' => 2, 'id' => 35, 'type' => CARD_COMBAT_ZONE],
  36 => ['round' => 2, 'id' => 36, 'type' => CARD_ABANDONED_SHIP, 'crew' => 5, 'reward' => 8, 'days_loss' => 2],
  37 => ['round' => 2, 'id' => 37, 'type' => CARD_ABANDONED_SHIP, 'crew' => 4, 'reward' => 6, 'days_loss' => 1],
  38 => [
    'round' => 2,
    'id' => 38,
    'type' => CARD_ABANDONED_STATION,
  ...
  39 => ['round' => 2, 'id' => 39, 'type' => CARD_ABANDONED_STATION, 'crew' => 7, 'reward' => ['red', 'yellow'], 'days_loss' => 1],
  40 => ['round' => 3, 'id' => 40, 'type' => CARD_SLAVERS],
  41 => ['round' => 3, 'id' => 41, 'type' => CARD_SMUGGLERS],
  42 => ['round' => 3, 'id' => 42, 'type' => CARD_PIRATES],
  43 => ['round' => 3, 'id' => 43, 'type' => CARD_SABOTAGE],
  44 => ['round' => 3, 'id' => 44, 'type' => CARD_EPIDEMIC],
  45 => ['round' => 3, 'id' => 45, 'type' => CARD_OPEN_SPACE],
  46 => ['round' => 3, 'id' => 46, 'type' => CARD_OPEN_SPACE],
  47 => ['round' => 3, 'id' => 47, 'type' => CARD_OPEN_SPACE],
  48 => ['round' => 3, 'id' => 48, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['b90', 's90', 'b90', 's0', 's180']],
  49 => [
    'round' => 3,
    'id' => 49,
    'type' => CARD_METEORIC_SWARM,
    'meteors' => ['b0', 's180', 's180', 's270', 's270', 's90', 's90'],
  ],
  50 => ['round' => 3, 'id' => 50, 'type' => CARD_METEORIC_SWARM, 'meteors' => ['b270', 's270', 'b270', 's0', 's180']],
  51 => [
    'round' => 3,
    'id' => 51,
    'type' => CARD_PLANETS,
  ...
  55 => ['round' => 3, 'id' => 55, 'type' => CARD_COMBAT_ZONE],
  56 => ['round' => 3, 'id' => 56, 'type' => CARD_ABANDONED_SHIP, 'crew' => 7, 'reward' => 11, 'days_loss' => 2],
  57 => ['round' => 3, 'id' => 57, 'type' => CARD_ABANDONED_SHIP, 'crew' => 6, 'reward' => 10, 'days_loss' => 2],
  58 => [
    'round' => 3,
    'id' => 58,
    'type' => CARD_ABANDONED_STATION,
