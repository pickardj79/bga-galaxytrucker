...
class view_galaxytrucker_galaxytrucker extends game_view
{
  ...
  function build_page($viewArgs)
  {
    ...
    $this->tpl['BUILD_MESSAGE'] = self::_(
      'You can pick and place components, look at ' .
    ...
    foreach ($players as $player_id => $player) {
      if ($player_id != $current_player_id) {
        $this->page->insert_block('opponent', [
          'PLAYER' => $player_id,
    ...
    for ($i = 0; $i <= 29; $i++) {
      $this->page->insert_block('rev_space', ['I' => $i]);
    }
